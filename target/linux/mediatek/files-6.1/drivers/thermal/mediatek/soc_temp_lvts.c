 ...
 * Modified by Elad Yifee <eladwf@gmail.com>
 */
...
static int soc_temp_lvts_read_temp(struct thermal_zone_device * tzd, int *temperature)
{
	struct soc_temp_tz *lvts_tz = (struct soc_temp_tz *)tzd->devdata;
